...
<body>
	<div id="content">
		...
		<ul>
			...
			<li>Location: Klaipeda, Lithuania</li>
			<li>Email: <a href="mailto:hello@nonamez.name">hello@nonamez.name</a></li>
		</ul>
		<h2>Online</h2>
		<ul>
			<li>
				<a href="https://www.github.com/nonamez">https://www.github.com/nonamez</a>
			</li>
			<li>
				<a href="https://www.linkedin.com/in/k1r1ll-pch3lk1n/">https://www.linkedin.com/in/k1r1ll-pch3lk1n</a>
			</li>
			<li>
		...
		<ul class="companies" style="margin-top: 10px">
			...
			<li>
				...
				<p>Responsible for various web projects</p>
			</li>
			<li>
