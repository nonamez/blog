	...
	<article class="post post-standalone" id="post-{{ $post['id'] }}" style="border-top: 1px solid #efefef">
		...
		<footer class="post-footer">
			<section class="share">
				...
				<a class="fa fa-google-plus-square google-plus" href="https://plus.google.com/share?url={{ URL::current() }}" onclick="window.open(this.href, 'google-plus-share', 'width=490,height=530');return false;" rel="tooltip" title="Отметить в Google+">
