...
{{ Form::open(['route' => 'post_store', 'class' => 'form-horizontal', 'style' => 'margin-bottom:15px']) }}
	<div class="row with-title" data-block-title="General">
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				{{ Form::textarea('content', $post['content'], ['class' => 'form-control', 'placeholder' => 'Enter text', 'size' => '5x5'])}}
			</div>
		</div>
	</div>
	<hr>
	<div class="row">
		<div class="col-md-6 with-title" data-block-title="Meta">
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					{{ Form::text('meta_description', $post['meta_description'], ['class' => 'form-control', 'placeholder' => 'Enter Description']) }}
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-4 control-label">Keywords</label>
				<div class="col-md-8">
					{{ Form::text('meta_keywords', $post['meta_keywords'], ['class' => 'form-control', 'placeholder' => 'Enter Keywords']) }}
				</div>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-md-6 with-title" data-block-title="Options">
			<div class="form-group">
				...
				<div class="col-md-6">
					{{ Form::select('locale', $locales, $post['locale'], array('class' => 'form-control')) }}
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-6 control-label">Status</label>
				<div class="col-md-6">
					{{ Form::select('status', array('draft' => 'Draft', 'published' => 'Published'), $post['status'], array('class' => 'form-control')) }}
				</div>
			</div>
		</div>
