...
class Translated extends Model
{
    ...
    protected $dispatchesEvents = [
        'saved'    => Events\Post\Translated\Saved::class,
        'deleting' => Events\Post\Translated\Deleting::class,
    ];
    ...
    {
    	return $this->belongsToMany(Models\Tags\Tag::class, 'blg_translated_posts_tags', 'post_id' ,'tag_id')->withTimestamps();
    }
